...
Source0  : https://ftp.postgresql.org/pub/source/v9.6.14/postgresql-9.6.14.tar.bz2
...
%prep
%setup -q -n postgresql-9.6.14
%patch1 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a postgresql-9.6.14 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1561074931
