...
Source0  : https://ftp.postgresql.org/pub/source/v9.6.19/postgresql-9.6.19.tar.bz2
...
%prep
%setup -q -n postgresql-9.6.19
cd %{_builddir}/postgresql-9.6.19
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a postgresql-9.6.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597344732
...
cp %{_builddir}/postgresql-9.6.19/COPYRIGHT %{buildroot}/usr/share/package-licenses/postgresql/97edc29bfb0112955a6b38640bea4882de01f3b9
cp %{_builddir}/postgresql-9.6.19/src/backend/regex/COPYRIGHT %{buildroot}/usr/share/package-licenses/postgresql/9ca05e9c70d9823e191d9b3876ecdeb57c53c725
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
