...
Source0  : https://ftp.postgresql.org/pub/source/v9.6.10/postgresql-9.6.10.tar.bz2
...
%prep
%setup -q -n postgresql-9.6.10
%patch1 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a postgresql-9.6.10 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1539141471
export AR=gcc-ar
