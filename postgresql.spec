...
%prep
%setup -q -n postgresql-9.6.16
cd %{_builddir}/postgresql-9.6.16
%patch1 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a postgresql-9.6.16 buildavx2
popd
...
cp %{_builddir}/postgresql-9.6.16/src/backend/regex/COPYRIGHT %{buildroot}/usr/share/package-licenses/postgresql/9ca05e9c70d9823e191d9b3876ecdeb57c53c725
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
