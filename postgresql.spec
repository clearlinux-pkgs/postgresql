...
Version  : 9.6.12
Release  : 57
URL      : https://ftp.postgresql.org/pub/source/v9.6.12/postgresql-9.6.12.tar.bz2
Source0  : https://ftp.postgresql.org/pub/source/v9.6.12/postgresql-9.6.12.tar.bz2
...
%prep
%setup -q -n postgresql-9.6.12
%patch1 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a postgresql-9.6.12 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1550191815
export AR=gcc-ar
